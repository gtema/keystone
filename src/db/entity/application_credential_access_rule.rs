...
#[sea_orm(table_name = "application_credential_access_rule")]
pub struct Model {
    #[sea_orm(primary_key, auto_increment = false)]
    pub application_credential_id: i32,
    #[sea_orm(primary_key, auto_increment = false)]
    pub access_rule_id: i32,
}

#[derive(Copy, Clone, Debug, EnumIter, DeriveRelation)]
pub enum Relation {
    #[sea_orm(
        belongs_to = "super::access_rule::Entity",
        from = "Column::AccessRuleId",
        to = "super::access_rule::Column::Id",
        on_update = "Restrict",
        on_delete = "Cascade"
    )]
    AccessRule,
