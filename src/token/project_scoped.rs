...
impl MsgPackToken for ProjectScopeToken {
    type Token = ProjectScopeToken;
...
mod tests {
    ...
    fn test_roundtrip() {
        ...
        let decoded =
            ProjectScopeToken::disassemble(&mut encoded_buf.as_slice(), &auth_map).unwrap();
